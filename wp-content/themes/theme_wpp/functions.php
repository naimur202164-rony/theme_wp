...
function naimur_customizar_register($wp_customize){
 ...
 // Menu Position Option
  ...
  $wp_customize->add_setting('naimur_menu_position', array(
    'default' => 'right_menu',
  ));

  $wp_customize-> add_control('naimur_menu_position', array(
    'label' => 'Menu Position',
    'description' => 'Select your menu position',
    'setting' => 'naimur_menu_position',
    'section' => 'naimur_menu_option',
    'type' => 'radio',
    'choices' => array(
      'left_menu' => 'Left Menu',
